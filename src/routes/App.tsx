            ...
            >
                ...
                >
                    <div className="grid grid-cols-1 text-white text-center">
                        <p className="text-[1.6em] ubuntu-medium">“Where integrity meets innovation.”</p>
                        <p className="text-[3.7em] font-bold">원칙이 혁신과 만나는 곳.</p>
                        <p className="text-[1.6em] ubuntu-medium">Market Insight Lab 이 함께합니다.</p>
                    </div>
                </div>
